...
eve runtime (agent/)
  ...
  • Tools: memory_{read,write,search,list} · execute_code (Sandbox) · vgpu_docs / vgpu_examples
...
| WebGPU docs | `agent/lib/vgpu-mcp.ts` | `MSTRMND_VGPU_MCP_URL` (default `https://vgpu.sh/api/mcp`) |
